Shareable.configure do |config|
  ...
  config.names = %w[  facebook twitter google_plus   ]
  ...
  config.recommendations='true' # 'true' or 'false'. '' defaults to 'true'.
  ...
  ##twitter
  ###############
  config.via='comunidar' # screen name of the user to attribute the tweet to.
  ...
  config.dnt='false' # 'true' or 'false'. 'true' tailors content and suggestions for twitter users.
