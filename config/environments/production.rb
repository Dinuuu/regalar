Regalar::Application.configure do
  ...
  config.action_mailer.default_url_options = { host: 'regalar-production.herokuapp.com' }
  ...
  config.middleware.use ExceptionNotification::Rack, email: {
    email_prefix: '[Regalar][regalar-production]',
    sender_address: 'mailer@regalar.com.ar',
    exception_recipients: 'dinu1389@gmail.com'
  }
