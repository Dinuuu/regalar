...
module LevelsCreationHelper
  ...
  class << self
    ...
    def create_levels
      ...
      Level.create(level: 4, title: 'Virgen de Calcuta', from: 31, to: 40)
      Level.create(level: 5, title: 'Robin Hood', from: 41, to: 50)
      Level.create(level: 6, title: 'Dios', from: 51, to: 60)
